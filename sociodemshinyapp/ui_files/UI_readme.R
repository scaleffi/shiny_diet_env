tabItem(
  ...
  fluidRow(
    box(width = 12,
        ...
        div(
          HTML(
            "This dashboard allows users to explore data on food-related environmental footprints in 2020, for 175 countries, across four socio-demographic characteristics (age; sex; education level; urban/rural residency),
            ...
            Estimates of food demand are built from FAOSTAT's Food Balance Sheets, available at: https://www.fao.org/faostat/en/#data/FBS. Estimates of daily intakes by sociodemographic are taken from the GDD, available at: https://globaldietarydatabase.org/.
