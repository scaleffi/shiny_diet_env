        ...
        # titlePanel("The environmental footprints of global diets"),
            dashboardSidebar(
              sidebarMenu(
                ...
                menuItem("Consumption data", tabName = "consumption", icon = icon("bowl-food")),
          ...
          ###First item
            ...
            ###Fourth item
                  ...
                  tabsetPanel(
                    tabPanel("About", box(
                      title = "About this data",
                      "These tabs display daily global intakes of different food groups."
                    )),
                    tabPanel(
                      "Consumption comparisons",
                        fluidRow(
                          box(
                            ...
                            selectInput("region_8", "Select Region:", choices = unique(df_cons$Region), selected = "WLD"),
